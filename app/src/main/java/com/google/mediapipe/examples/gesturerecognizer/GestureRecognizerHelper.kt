...
class GestureRecognizerHelper(
    ...
    fun setupGestureRecognizer() {
        ...
        baseOptionBuilder.setModelAssetPath(mpRecognizerTask)
    ...
    companion object {
        ...
        public var mpRecognizerTask: String = "ASL.task"
    ...
    fun updateRecognizerTask(language: String) {
        mpRecognizerTask = when (language) {
            "American" -> "ASL.task"
            "French" -> "ASL.task"
            "Arabic" -> "ArSL.task"
            else -> "ASL.task" // Set a default value if needed
        }
        setupGestureRecognizer() // Reinitialize with the updated task
    }
}
